...
waitingTimeModified=textread('E:\\CSE\\CSE 8th sem\\project\\GT Charge Modified\\Put_AVERAGE_WAITING.txt','%f');
deadTimeModified=textread('E:\\CSE\\CSE 8th sem\\project\\GT Charge Modified\\Put_DEAD_TIME.txt','%d');
